// Copyright (c) 2014-2018 The HOPE Developers
// Copyright (c) 2011-2013 The PPCoin developers
// Stake cache ancestry: Qtum
// HOPE Bitcoin Core 31.1 migration draft: UNTESTED / DO NOT RELEASE
...
/**
 * Validate the consensus-specific first input of a HOPE coinstake against a
