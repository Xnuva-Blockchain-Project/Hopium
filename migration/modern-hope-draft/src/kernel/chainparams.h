...
public:
    ...
    // Modern Bitcoin uses Bech32 here. Historical HOPE did not.
    // The migration keeps this blank until an address-format decision is made.
    const std::string& Bech32HRP() const { return bech32_hrp; }

    // HOPE LEGACY IDENTITY: retained for the legacy CashAddr-compatible codec
    ...
    // Historical HOPE has main, test and regtest. Bitcoin testnet4/signet are
    // intentionally not treated as HOPE networks in this migration.
