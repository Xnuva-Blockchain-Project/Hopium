...
// HOPE LEGACY CONSENSUS: difficulty is calculated separately for the previous
// block of the same proof type (PoW or PoS).
...
// Modern Bitcoin-compatible PoW entry points retained as wrappers.
