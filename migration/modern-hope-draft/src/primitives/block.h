...
public:
    ...
    // HOPE LEGACY CONSENSUS: PoS blocks serialize a block signature after vtx.
    ...
    // HOPE LEGACY CONSENSUS: classify blocks using the coinstake transaction.
