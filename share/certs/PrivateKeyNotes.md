...
unlocked to sign the Hopium-Qt.app bundle.
...
allowing somebody to distribute a Hopium-Qt.app or hopium-qt-setup.exe with a valid
...
that the hopium-qt.exe file inside the installer had not been tampered with.
