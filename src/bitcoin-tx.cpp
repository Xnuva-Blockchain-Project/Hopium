...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s hopium-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  hopium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hopium transaction") + "\n" +
              "  hopium-tx [options] -create [commands]   " + _("Create hex-encoded hopium transaction") + "\n" +
              "\n";
