...
#if defined(NDEBUG)
# error "Hopium cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Hopium Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // Hopium also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // Hopium also requires low S in sigs
