...
const QString BITCOIN_IPC_PREFIX("hopium:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/hopium-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/hopium-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/hopium-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click hopium: links
...
//
// OSX-specific way of handling hopium: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in hopium: URIs
