...
BOOST_AUTO_TEST_CASE(rpc_rawparams)
{
    ...
    string rawtx = "";
...
BOOST_AUTO_TEST_CASE(rpc_rawsign)
{
    ...
    r = CallRPC(string("createrawtransaction ")+prevout+" "+
      "{\"Hmzt645FvgRLKGNB65Y3xybErjkVz5GwYk\":11}");
    string notsigned = r.get_str();
    string privkey1 = "\"Rv4kr4E8jfjZMnBUe37CoPBb6gjyYeqad1j5575sirEKmQ98TWYj\"";
    string privkey2 = "\"RttrXXktKc5T3PApH1Nt2qVx7tmap3ubnd5Y8C7ByxAkzWLgfF2t\"";
...
BOOST_AUTO_TEST_CASE(rpc_parse_monetary_values)
{
    ...
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("0"), true), 0LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("0.00000000"), true), 0LL);
...
BOOST_AUTO_TEST_CASE(rpc_ban)
{
    ...
    BOOST_CHECK_NO_THROW(r = CallRPC(string("setban 127.0.0.0/24 add ") + std::to_string(absoluteBanTime) + " true"));
    BOOST_CHECK_NO_THROW(r = CallRPC(string("listbanned")));
    ar = r.get_array();
    o1 = ar[0].get_obj();
    ...
    BOOST_CHECK_EQUAL(banned_until.get_int64(), absoluteBanTime); // absolute time check
